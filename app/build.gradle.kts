...
android {
    namespace = "com.faroquetech.rootrealm"
    compileSdk = 36 
    ...
    defaultConfig {
        applicationId = "com.faroquetech.rootrealm"
        minSdk = 31 
        targetSdk = 36  
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Decompresses REPLACE_XZ operations when reconstructing partition
    // images from payload.bin (PayloadImageExtractor loads this via
    // reflection, so it's optional at compile time but required for
    // "Extract IMG files" to actually reconstruct XZ-compressed partitions).
